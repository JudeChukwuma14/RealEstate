...
//   return (
//     <div className=" bg-center bg-no-repeat  bg-home w-[100%] h-[90vh]  bg-cover">
...
//             <img
//               src={whitelog}
//               className=" hidden md:flex md:w-[300px] lg:w-[200px]"
//             />
//           </div>
...
//                <a href={`tel:${phonenumber}`}> <FiPhoneCall /></a>
...
//               <NavLink to="/rental-manager" className="flex justify-center items-center w-[140px] h-[42px] text-sm border rounded-md text-gray-100 cursor-pointer hover:text-white hover:font-bold">
//                 Add a Property
//               </NavLink>
//               <NavLink to='/become-partner' className=" flex justify-center items-center w-[140px] h-[42px] text-sm border rounded-md text-gray-100 cursor-pointer hover:text-white hover:font-bold">
//                 Become a Partner
//               </NavLink>
//             </div>
//           </div>
